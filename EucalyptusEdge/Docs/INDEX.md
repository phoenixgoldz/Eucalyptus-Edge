...
- `02_ClaudeCode_UE5\` — PROJECT_AUDIT.md (Session 1: inspection only, known-state synced 2026-07-17), FOR_CLAUDE_CODE_UE5.md brief, handoff_charselect.md (paradigm-synced: UMG overlay for the Dynamic Character Select), VERTICAL_SLICE_MILESTONES.md, layout mock.
